...
public class CommandTestUtil {
    ...
    public static final String INVALID_NAME_DESC_SUGGESTION = " " + PREFIX_NAME + "James"; // Suggest removing '&'
    public static final String INVALID_PHONE_DESC = " " + PREFIX_PHONE + "911a"; // 'a' not allowed in phones
    public static final String INVALID_EMAIL_DESC = " " + PREFIX_EMAIL + "bob!yahoo"; // missing '@' symbol
    public static final String INVALID_ADDRESS_DESC = " " + PREFIX_ADDRESS; // empty string not allowed for addresses
    public static final String INVALID_TAG_DESC = " " + PREFIX_TAG + "hubby*"; // '*' not allowed in tags
    public static final String INVALID_TAG_DESC_SUGGESTION = " " + PREFIX_TAG + "hubby"; // Suggest removing '*'
    ...
    public static void showFirstPersonOnly(Model model) {
        ...
        assert model.getLatestPersonList().size() == 1;
    }
